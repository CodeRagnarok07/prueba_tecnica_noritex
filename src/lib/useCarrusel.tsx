...
const useCarrusel = () => {
    ...
    /**
     * Changes the current slide based on the direction given.
     *
     * @param direction - `true` for next slide, `false` for previous slide.
     */
    const arrowControler = (direction: boolean): void => {
        ...
        setCurrent(current + (direction ? 1 : -1));
        if (direction) {
